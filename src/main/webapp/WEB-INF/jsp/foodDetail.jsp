...
<div class="container">
    ...
    <div class="row clearfix">
        <div class="col-md-12 column">
            ...
            <div style="margin-left: 100px;margin-top: 25px"><a href="/addComment"><img src="loginSpecial/static/img/pinglun.png" width="30px" height="30px"/></a></div>
           ...
           <c:forEach items="${comments}" var="comment" end="2">
            ...
            <a class="navbar-brand" href="/backmain">首页</a>
        </div>
    </div>
</div>
</body>
